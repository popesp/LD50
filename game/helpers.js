...
export function makeCardContainer(scene, card, x, y)
{
	...
	const carddescription = scene.add.text(0, OFFSET_CARDDESCRIPTION, card.description, {color: "black", fontSize: "12px", align: "center", wordWrap: {width: WIDTH_CARD - PADDING_CARD*2}}).setOrigin(0.5);
